...
const ORG_MODES = {
  instruct: {
    hint: "何をしてほしいか書くだけで、内容に応じた役割に自動で振り分けて起動します。",
    placeholder: "例: ログイン画面のバリデーションを直して／レビューして／設計して",
  },
  goal: {
    hint: "達成したい目標を書くと、マネージャーがタスクに分解して各役割へ振り分けます。",
    placeholder: "例: もっと使いやすく／セキュリティ強化／離脱を減らしたい",
  },
};
